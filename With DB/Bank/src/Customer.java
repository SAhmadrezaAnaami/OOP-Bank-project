...
public class Customer extends Person{
    ...
    public Customer(String firstName, String lastName, String userPass, String accountID, String phoneNumber,
            String address, Double balance, AccountType accountType , ArrayList<String> history) {
    ...
    public static Customer getCustomer(){
        ...
        switch (type) {
            case 1:
                ...
                accountType = new ShortType(interest , 1);
                break;
            ...
            case 2:
                ...
                accountType = new LongType(interest , lockTime ,1);
            break;
            case 3 :
                accountType = new SaveType(1);
                break;
        ...
        Customer C = new Customer(firstName , lastName, userPass, accountID , phoneNumber ,address , balance , accountType , history2);
        return C ; 
